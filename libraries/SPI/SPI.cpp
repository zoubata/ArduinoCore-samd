...
int SPIClass::enabled()
{
	if (!initialized)
		return initialized;
    return (((_p_sercom->mode()>>1)&0x3)==0x1);
}
void SPIClass::begin()
{
  init();
