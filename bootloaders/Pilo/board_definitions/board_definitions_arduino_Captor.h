...
/* PILO ****/
	...
	#define BOOT_USART_PAD0                   PINMUX_UNUSED
	#define BOOT_USART_PAD1                   PINMUX_UNUSED
#elif defined( BOOT_PCOM0_SERIAL2) // booot from pi
	...
	#define BOOT_USART_PAD1                   PINMUX_UNUSED
	#define BOOT_USART_PAD0                   PINMUX_UNUSED
#elif defined( BOOT_PCOM0_SERIAL1) // booot from pi
	#define BOOT_USART_SERCOM_INSTANCE        4
	#define BOOT_USART_PAD_SETTINGS           UART_RX_PAD1_TX_PAD0
	#define BOOT_USART_PAD3                   PINMUX_UNUSED
	#define BOOT_USART_PAD2                   PINMUX_UNUSED
	#define BOOT_USART_PAD1                   PINMUX_PB25D_SERCOM4_PAD1
	#define BOOT_USART_PAD0                   PINMUX_PB24D_SERCOM4_PAD0
	
#elif defined( BOOT_engi) // booot from pi	
